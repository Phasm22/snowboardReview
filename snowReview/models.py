...
class Snowboard(models.Model):
    ...
    season = models.CharField(max_length=10, default='Unknown')
    terrain = models.ManyToManyField(Terrain)
    shape = models.CharField(max_length=40, choices=SHAPES, default=SHAPES[0][0])
    profile = models.CharField(max_length=40, choices=PROFILES, default=PROFILES[0][0])
    rider = models.CharField(max_length=40, choices=SKILL, default=SKILL[0][0])
